...
<body>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-outline mb-4">
                                                                    ...
                                                                    <input type="text" id="form6Example4"
                                                                        class="form-control required1" name="address"
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-outline mb-4">
                                                                    ...
                                                                    <select class="form-control required1"
                                                                        name="occupation"
                                                                        err="Occupation Field is required">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-outline mb-4">
                                                                    <label class="form-label"
                                                                        ...
                                                                        Contact:</label><span class="err-txt"></span>
                                                                    <input type="tel" class="form-control required1"
                                                                        placeholder="Enter number" name="emergency"
                                                                        err="Emergency Contact Field is required">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col--12 col-sm-12 col-md-6 col-lg-6 form">
                                                        <div class="label">
                                                            <div class="form-row">
                                                                <div class="col-md-6">
                                                                    <div class="form-outline mb-4">
                                                                        <label>Home Phone:&nbsp;(include area
                                                                            code)</label><span class="err-txt"></span>
                                                                        <input type="tel" name="hnumber"
                                                                            class="form-control required1"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-outline mb-4">
                                                                        <label>Business Phone:(include area
                                                                            code)</label><span class="err-txt"></span>
                                                                        <input type="tel" name="bnumber"
                                                                            class="form-control"
                                                                            placeholder="Enter Number">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-outline mb-4">
                                                                        <label class="form-label"
                                                                            ...
                                                                            class="err-txt"></span>
                                                                        <select class="form-control required1"
                                                                            name="city" err="City Field is required">
                                                                            <option>Select</option>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-outline mb-4">
                                                                        <label class="form-label"
                                                                            ...
                                                                            class="err-txt"></span>
                                                                        <select class="form-control required1"
                                                                            name="state" err="State Field is required">
                                                                            <option>Select</option>
                                                                            <option value="Ex1">Ex1</option>
                                                                            <option value="Ex2">Ex2</option>
                                                                            <option value="EX3">EX3</option>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-outline mb-4">
                                                                        <label>Home Phone:<span class="code">(include
                                                                                area code)</span></label><span
                                                                            class="err-txt"></span>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-outline mb-4">
                                                                        <label>Cell Phone:<span class="code">(include
                                                                                area code)</span></label><span
                                                                            class="err-txt"></span>
                                                                        <input type="tel" name="cellnum"
                                                                            class="form-control required1"
                                                                            placeholder="Enter Number"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Persistent cough greater than a 3
                                                                        week duration.</td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="Persistent"
                                                                            value="yes">
                                                                    </td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="Persistent"
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Been exposed to anyone with
                                                                        tuberculosis.</td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="Been"
                                                                            value="yes">
                                                                    </td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="Been" value="no">
                                                                    </td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="Been" value="dk">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <div class="col-md-12 nextt">
                                                        <div class="text-center">
                                                            <a href="#strategy" aria-controls="strategy" role="tab"
                                                                data-toggle="tab"><button type="button" class=""
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td data-label="">Do your gums bleed when you brush
                                                                        or floss?</td><span class="err-txt"></span>
                                                                    <td class="dare"><input class="required2"
                                                                            type="radio" id="inlineCheckbox1"
                                                                            name="floss" value="yes"
                                                                            err="This Field is required">
                                                                    </td>
                                                                    <td class="dare"><input class=" " type="radio"
                                                                            id="inlineCheckbox1" name="floss"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class=" " type="radio"
                                                                            id="inlineCheckbox1" name="floss"
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Are your teeth sensitive to cold,
                                                                        hot, sweets or
                                                                        pressure?</td><span class="err-txt"></span>
                                                                    <td class="dare"><input type="radio"
                                                                            clas="required2" id="inlineCheckbox1"
                                                                            name="sensitive" value="yes"
                                                                            err="This Field is required">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="sensitive"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="sensitive"
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Does food or floss catch between
                                                                        your teeth?</td><span class="err-txt"></span>
                                                                    <td class="dare"><input class="required2"
                                                                            type="radio" id="inlineCheckbox1"
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="foodorfloss"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="foodorfloss"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="periodontal"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="periodontal"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="orthodontic"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="orthodontic"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="associated_treat"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="associated_treat"
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Is your home water supply
                                                                        fluoridated?</td><span class="err-txt"></span>
                                                                    <td class="dare"><input class="required2"
                                                                            type="radio" id="inlineCheckbox1"
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="fluoridated"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="fluoridated"
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Do you drink bottled or filtered
                                                                        water?</td><span class="err-txt"></span>
                                                                    <td class="dare"><input class="required2"
                                                                            type="radio" id="inlineCheckbox1"
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="filtered"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="filtered"
                                                                ...
                                                                <tr>
                                                                    <td data-label="">If yes, how often? Select one:
                                                                        DAILY / WEEKLY /
                                                                        OCCASIONALLY</td><span class="err-txt"></span>
                                                                </tr>
                                                                <tr>
                                                                    <td><select class="form-control required2"
                                                                            name="daily_week"
                                                                            err="This Field is required">
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Are you currently experiencing
                                                                        dental pain or
                                                                        discomfort?</td><span class="err-txt"></span>
                                                                    <td class="dare"><input class="required2"
                                                                            type="radio" id="inlineCheckbox1"
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="discomfort"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="discomfort"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Do you have any clicking, popping
                                                                        or discomfort in
                                                                        the
                                                                        jaw?</td><span class="err-txt"></span>
                                                                    <td class="dare"><input class="required2"
                                                                            type="radio" id="inlineCheckbox1"
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="popping"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="popping"
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Do you have sores or ulcers in
                                                                        your mouth?</td><span class="err-txt"></span>
                                                                    <td class="dare"><input class="required2"
                                                                            type="radio" id="inlineCheckbox1"
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Have you ever had a serious injury
                                                                        to your head or
                                                                        mouth?</td><span class="err-txt"></span>
                                                                    <td class="dare"><input class="required2"
                                                                            type="radio" id="inlineCheckbox1"
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="injury"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="injury"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <div class="form-group green-border-focus smile">
                                                            <label for="exampleFormControlTextarea5">How do you feel
                                                                about your
                                                                smile?</label><span class="err-txt"></span>
                                                            <textarea class="form-control required2"
                                                                id="exampleFormControlTextarea5" rows="3"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="text-center">
                                                            ...
                                                            <a href="#optimization" aria-controls="optimization"
                                                                role="tab" data-toggle="tab"><button type="button"
                                                                    class="bt-nxt" id="next2">Next</button></a>
                                                        </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                                        <table class="den">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Are you in good health?</td><span
                                                                        class="err-txt"></span>
                                                                    <td class="dare"><input class="required3"
                                                                            type="radio" id="inlineCheckbox1"
                                                                            name="goodhealth" value="yes"
                                                                            err="This Field is required">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="goodhealth"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="goodhealth"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td data-label="">Have you had a serious illness,
                                                                        operation or been
                                                                        hospitalized in the past 5 years?</td><span
                                                                        class="err-txt"></span>
                                                                    <td class="dare"><input class="required3"
                                                                            type="radio" id="inlineCheckbox1"
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="hospitalized"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="hospitalized"
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                                        <table class="den">
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col"> Check DK if you Don't Know the
                                                                        answer to the
                                                                        question
                                                                    </th>
                                                                    <th scope="col" class="resp">Yes</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="orthopedic"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="orthopedic"
                                                        ...
                                                        <table class="den">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="Pregnant"
                                                                            value="yes">
                                                                    </td>
                                                                    <td class="dare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="Pregnant"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="text-center">
                                                            ...
                                                            <a href="#content" aria-controls="content" role="tab"
                                                                data-toggle="tab"><button type="button" class="bt-nxt"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td data-label="">Artificial (prosthetic) heart
                                                                        valve.</td><span class="err-txt"></span>
                                                                    ...
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="heartvalve"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="heartvalve"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="endocarditis"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="endocarditis"
                                                                ...
                                                                <tr>
                                                                    <td data-label="">Damaged valves in transplanted
                                                                        heart.</td><span class="err-txt"></span>
                                                                    <td class="rare"><input class="required4"
                                                                            type="radio" id="inlineCheckbox1"
                                                                    ...
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="Damaged"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="Damaged"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <span class="err-txt"></span>
                                                                    <td class="rare"><input class="required4"
                                                                            type="radio" id="inlineCheckbox1" name="CHD"
                                                                            value="yes" err="This Field is required">
                                                                    </td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="CHD" value="no">
                                                                    </td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="CHD" value="dk">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td data-label="">Repaired (completely) in last 6
                                                                        months.</td><span class="err-txt"></span>
                                                                    <td class="rare"><input class="required4"
                                                                            type="radio" id="inlineCheckbox1"
                                                                    ...
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="last_mon"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="rare"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="last_mon"
                                                            ...
                                                            <table class="valve">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="dare"><input class="" type="radio"
                                                                                id="inlineCheckbox1" name="transmitted"
                                                                                value="no">
                                                                        </td>
                                                                        <td class="dare"><input class="" type="radio"
                                                                                id="inlineCheckbox1" name="transmitted"
                                                        ...
                                                        <table class="take">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="prior"><input class="required5"
                                                                            type="radio" id="inlineCheckbox1"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="prior required5"><input class=""
                                                                            type="radio" id="inlineCheckbox1"
                                                                            name="have_dis" value="yes">
                                                                    </td>
                                                                    <td class="prior"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="have_dis"
                                                                            value="no">
                                                                    </td>
                                                                    <td class="prior"><input class="" type="radio"
                                                                            id="inlineCheckbox1" name="have_dis"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                                        <div class="row">
                                                            <div class="col-md-12 sign">
                                                                <h1>Signature of Patient/Legal Guardian:</h1><span
                                                                    class="err-txt"></span>
                                                            </div>
                                                        </div>
    ...
    <footer>
            ...
            $("#next").hover(function(e) {
                ...
                $("#medical_form").find('.required1').each(function() {
                    if ($(this).val() == "" || $(this).val() == null) {
                        ...
                        // $(this).html($(this).attr('err'));
                        // console.log(`err is ${$(this).attr("err")}`)
                    } else {
        ...
        <script>
        $(document).ready(function() {
            $("#next4").hover(function(e) {
                let empty = true;
                $("#medical_form").find('.required4').each(function() {
                    if ($(this).val() == "" || $(this).val() == null) {
                        $empty = false;
        ...
        <script>
        $(document).ready(function() {
            $("#submit_form").hover(function(e) {
                let empty = true;
                $("#medical_form").find('.required5').each(function() {
                    if ($(this).val() == "" || $(this).val() == null) {
                        $empty = false;
